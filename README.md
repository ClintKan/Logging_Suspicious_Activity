...
**Step 1:**
Created a directory: mkdir analyz_logfiles_hw

**Step 2:**
Navigated into that directory: cd ~/analyz_logfiles_hw

**Step 3:**
Cloned the shell script from GitHub – by cloning the whole repo.
git clone https://github.com/kura-labs-org/install-sh.git
...
Copying using the syntax: cp /home/ubuntu/analyz_logfiles_hw/install-sh ~/ analyz_logfiles_hw
Note: ~ = /home/ubuntu
...
**Step 5:**
Then made the file executable: chmod +x ~/auth_log_creation.sh
